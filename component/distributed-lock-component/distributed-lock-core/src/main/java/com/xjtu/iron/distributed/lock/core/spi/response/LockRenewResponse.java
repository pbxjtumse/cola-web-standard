...
public final class LockRenewResponse {
    ...
    public static LockRenewResponse failed(Throwable error) { return builder().status(LockRenewStatus.PROVIDER_ERROR).error(error).message(error == null ? null : error.getMessage()).build(); }
