...
@ConditionalOnProperty(prefix = "xjtu.iron.distributed-lock.redisson",
...
public class RedissonDistributedLockAutoConfiguration {
    ...
    @ConditionalOnProperty(prefix = "xjtu.iron.distributed-lock.redisson",
            name = "create-client-if-missing", havingValue = "true", matchIfMissing = true)
    ...
    @ConditionalOnMissingBean
    public RedissonLockProvider redissonLockProvider(
