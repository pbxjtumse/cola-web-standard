...
-- 5 processingTimeoutMs, 6 recoverFailed, 7 expectedOwner, 8 expectedVersion
local key = KEYS[1]
...
local recoverFailed = ARGV[6] == '1'
local expectedOwner = ARGV[7]
local expectedVersion = ARGV[8]
...
-- SHORT_TERM 窗口已经结束时不再恢复旧 generation。
